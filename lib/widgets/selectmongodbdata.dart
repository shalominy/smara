...
class SelectMongodbData extends StatefulWidget {
  ...
  const SelectMongodbData({Key? key, required this.items, required this.selecteditems}) : super(key: key);

  @override
  _MultiSelectState createState() => _MultiSelectState();
}

class _MultiSelectState extends State<SelectMongodbData> {
  ...
  void _itemChange(List<String> itemValue, bool isSelected) {
    setState(() { 
      ...
      if (isSelected) {
        ...
        widget.selecteditems.removeWhere((item) => const ListEquality().equals(item, itemValue));
      }
        ...
        child: ListBody(
          children: widget.items
              .map((item) => CheckboxListTile(
                    ...
                    value: widget.selecteditems.any((selectedd) => selectedd[0] == item [0]),
